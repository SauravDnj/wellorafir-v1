...
const heroSlides = [
  {
    ...
    heading:  ["Weight Loss That", "Finally Works —", "The WelloraFit Way"],
    accent:   "Finally Works —",
    sub:      "Stop chasing quick fixes. At WelloraFit, we combine medical science, personalized plans, and expert support to help you lose fat safely and sustainably — and keep it off for good.",
    cta:      "Start Your Transformation",
    img:      "/images/slides/slider-1.jpeg",
    stat:     { value: "500+", label: "Happy Clients" },
    tag:      "India's Integrated Wellness System",
    color:    "#0EA5E9",
  },
  {
    label:    "Blood Analysis & Metabolic Health",
    heading:  ["Your Body Has", "Answers —", "We Read Them"],
    accent:   "Answers —",
    sub:      "No more guessing. Our detailed blood analysis uncovers your metabolism, hormones, deficiencies, and fat-storing triggers — so your weight loss plan is built exactly for YOUR body.",
    cta:      "Unlock Your Body Insights",
    img:      "/images/slides/slider-2.jpeg",
  ...
  },
  {
    ...
    heading:  ["Real Doctors.", "Real Science.", "Real Results."],
    accent:   "Real Science.",
    sub:      "Weight loss isn't just about diet — it's about your health. Our medical experts monitor your progress, address root causes, and ensure your transformation is safe, effective, and sustainable.",
    cta:      "Consult Our Doctors",
    img:      "/images/slides/slider-3.jpeg",
    stat:     { value: "95%", label: "Client Success Rate" },
    tag:      "Licensed Medical Experts",
    color:    "#06B6D4",
  },
  {
    label:    "Personalized Plans",
    heading:  ["Plans Made for You —", "Not Copied", "for You"],
    accent:   "Not Copied",
    sub:      "Get customized diet and fitness plans designed by certified nutritionists and fitness experts — based on your body type, lifestyle, and goals. No extreme diets. No burnout workouts. Just results that fit your life.",
    cta:      "Get Your Custom Plan",
    img:      "/images/slides/slider-4.jpeg",
    stat:     { value: "12+", label: "Expert Specialists" },
    tag:      "Lifestyle Coaching",
    color:    "#6366F1",
  },
  {
    label:    "Smart Fat Loss Technology",
    heading:  ["See How Your Body", "Reacts —", "In Real Time"],
    accent:   "Reacts —",
    sub:      "With Continuous Glucose Monitoring (CGM), track how your body responds to food, stress, and daily habits. Optimize your diet scientifically and accelerate fat loss with real-time insights.",
    cta:      "Experience Smart Fat Loss",
    img:      "/images/slides/slider-5.jpeg",
    stat:     { value: "4", label: "Integrated Pillars" },
    tag:      "Real-Time Health Insights",
    color:    "#EC4899",
  },
];
